...
class Assembly : public Model::HasID, public std::enable_shared_from_this<Model::Assembly>
{
 public:
  std::string Name;
  ...
  std::shared_ptr<Model::Part> AddPart();
  std::shared_ptr<Model::Part> AddPart( std::string name );
